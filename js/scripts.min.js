function initMap() {
    var e = {
            lat: 53.62046189888696,
            lng: -6.490077300787825
        },
...
$(document).ready(function() {
    ...
    var r = createCalendar({
        ...
        data: {
            ...
            start: new Date("Dec 11, 2021 13:00"),
            end: new Date("Dec 11, 2021 00:00"),
            address: "Church of the Immaculate Conception, Rathfeigh, Co.Meath,Ireland",
            description: "We can't wait to see you on our big day. For any queries or issues, please contact Shane at +353 877615051."
        }
    });
    $("#add-to-cal").html(r), $("#rsvp-form").on("submit", function(e) {
        e.preventDefault();
        var t = $(this).serialize();
        $("#alert-wrapper").html(alert_markup("info", "<strong>Just a sec!</strong> We are saving your details.")), "b0e53b10c1f55ede516b240036b88f40" !== MD5($("#invite_code").val()) && "2ac7f43695eb0479d5846bb38eec59cc" !== MD5($("#invite_code").val()) ? $("#alert-wrapper").html(alert_markup("danger", "<strong>Sorry!</strong> Your invite code is incorrect.")) : $.post("https://script.google.com/macros/s/AKfycbyqAOz5B1JWrtDvVspO0WQw5tY2a5xNhRM5lDnc-dmAMZylqsSVWKBgLJjSQaq2ehkt/exec", t).done(function(e) {
